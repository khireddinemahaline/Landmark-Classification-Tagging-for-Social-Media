...
def get_model_transfer_learning(model_name="resnet18", n_classes=50):
    ...
    # 1. get numbers of features extracdted by the backbone
    num_ftrs  = model_transfer.fc.in_features

    # 2. Create a new linear layer with the appropriate number of inputs andf
    #    outputs
...
def data_loaders():
    ...
    return get_data_loaders(batch_size=2, valid_size=0.2 , num_workers = 0 , limit = 0)
